        ...
        return this.each(function() {
            ...
            function i() {
                if (d >= t) {
                    ...
                    jQuery(".mean-container").prepend('<div class="mean-bar"><span class="meanmenu-title">MENU</span></span><a href="#nav" class="meanmenu-reveal" style="' + R + '">Show Navigation</a><nav class="mean-nav"></nav></div>');
                    var e = jQuery(u).html();
